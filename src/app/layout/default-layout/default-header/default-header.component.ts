...
export class DefaultHeaderComponent extends HeaderComponent {
  ...
  ngOnInit(): void {
    // console.log('sessionStorage:', sessionStorage);  // Log all sessionStorage keys and values
  
    this.username = sessionStorage.getItem('nserName');
  }
  ...
  logout(): void {
    ...
    // sessionStorage.removeItem('otherSessionData');
